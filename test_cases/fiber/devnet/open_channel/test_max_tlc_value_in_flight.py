...
class TestMaxTlcNumberInFlight(FiberTest):
    ...
    def test_ckb_max_tlc_value_in_flight_not_eq_default(self):
        ...
        payment_preimage = self.generate_random_preimage()
        channels = self.fiber1.get_client().list_channels({})
        # fiber1's max_tlc_value_in_flight limits incoming TLCs from fiber2,
        # so it should not limit fiber1 -> fiber2 payments.
        invoice_balance = hex(1 * 100000000 + 1)
        ...
        # fiber2 -> fiber1 consumes fiber1's advertised incoming TLC value limit.
