"""
Test cases for shutdown_channel RPC force parameter.
Covers: peer offline/online, channel states (AWAITING_TX_SIGNATURES, CHANNEL_READY), force close, CKB/UDT.
"""
import time
...
class TestForce(FiberTest):
    """
    Test shutdown_channel force: peer offline/online, invalid state (AWAITING_TX_SIGNATURES),
    in-flight payment, force CKB/UDT close, graph_channels after force.
    """
    ...
    def test_in_tx(self):
        ...
        # todo check
        assert payment["status"] == PaymentStatus.INFLIGHT
    ...
    def test_in_tx_force_2(self):
        ...
        for i in range(100):
            self.send_payment(self.fiber1, self.fiber2, Amount.ckb(1), False)
        self.fiber1.get_client().shutdown_channel(
            {
    ...
    def test_in_tx_offline(self):
        ...
        # Send payment using the created invoice (peer initiates shutdown first)
...
"channel_id": channel_id,
    ...
    def test_force_ckb(self):
        ...
        invoice_balance = hex(Amount.ckb(50))
