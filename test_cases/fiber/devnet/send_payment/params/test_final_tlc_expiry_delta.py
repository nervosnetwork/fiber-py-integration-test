...
class TestFinalTlcExpiryDelta(FiberTest):
    ...
    # @pytest.mark.skip("https://github.com/cryptape/acceptance-internal/issues/1262#issuecomment-3680264403")
    def test_final_tlc_expiry_delta_with_final_tlc_expiry_delta(self):
        """
        - new_invoice 的final_expiry_delta > send_payment.final_tlc_expiry_delta ,预期成功，最终tlc的过期时间为new_invoice 的final_expiry_delta
        - new_invoice 的final_expiry_delta == send_payment.final_tlc_expiry_delta，预期成功
        - new_invoice 的final_expiry_delta < send_payment.final_tlc_expiry_delta, 预期成功，最终tlc的过期时间为new_invoice 的final_expiry_delta
        - send_payment.tlc_expiry_limit > new_invoice.final_expiry_delta 预期失败
